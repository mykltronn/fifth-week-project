...
// <input type="submit" name="playagain" value="">

// so now req.body.playagain when clicked should run req.session.destroy();
// can you test if req.body.playagain is true or false maybe? the .destroy()?
